...
public class InventoryUtils
{
    ...
    public static void dropAllMatchingStacks(ContainerScreen<? extends Container> gui, ItemStack stackReference)
    {
    ...
    public static void throwAllNonRecipeItemsToGround(RecipePattern recipe, ContainerScreen<? extends Container> gui)
    {
        Slot outputSlot = CraftingHandler.getFirstCraftingOutputSlotForGui(gui);
